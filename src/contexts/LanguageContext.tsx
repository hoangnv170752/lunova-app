...
const translations = {
  en: {
    ...
    'dashboard.tickets.date': 'Date',
    'dashboard.tickets.actions': 'Actions',
    'dashboard.tickets.view': 'View',
    'dashboard.tickets.close': 'Close',
    'dashboard.tickets.reopen': 'Reopen',
    'dashboard.tickets.delete': 'Delete',
    'dashboard.tickets.loading': 'Loading tickets...',
    'dashboard.tickets.tryAgain': 'Try Again',
    'dashboard.tickets.noTickets': 'No tickets created',
    'dashboard.tickets.tickets': 'tickets',
    'dashboard.tickets.descending': 'Descending',
    'dashboard.tickets.ascending': 'Ascending',
    'dashboard.tickets.sortByDate': 'Date',
    'dashboard.tickets.sortByPriority': 'Priority',
    'dashboard.tickets.sortByStatus': 'Status',
    'dashboard.tickets.responses': 'Responses',
    'dashboard.tickets.noResponses': 'No responses yet',
    'dashboard.tickets.statusOpen': 'Open',
    'dashboard.tickets.statusClosed': 'Closed',
    'dashboard.tickets.statusPending': 'Pending',
    'dashboard.tickets.priorityLow': 'Low',
    'dashboard.tickets.priorityMedium': 'Medium',
    'dashboard.tickets.priorityHigh': 'High',
    'dashboard.tickets.priorityUrgent': 'Urgent',
    'dashboard.tickets.filterAll': 'All',
    'dashboard.tickets.filterByStatus': 'Filter by Status',
    'dashboard.tickets.filterByPriority': 'Filter by Priority',
    'dashboard.tickets.filterByCategory': 'Filter by Category',
    'dashboard.tickets.description': 'Description',
    'dashboard.tickets.category': 'Category',
    'dashboard.tickets.addResponse': 'Add Response',
    'dashboard.tickets.typeResponse': 'Type your response...',
    'dashboard.tickets.submitting': 'Submitting...',
    'dashboard.tickets.submit': 'Submit',
    'dashboard.tickets.staff': 'Staff',
    'dashboard.tickets.user': 'User',
    'dashboard.tickets.aiSuggestion': 'AI Suggestion',
    'dashboard.tickets.generating': 'Generating...',
    ...
    'dashboard.products.uploadImages': 'Upload Images',
    'dashboard.products.uploadImagesFor': 'Upload Images for',
    'dashboard.products.dragDropImages': 'Drag and drop images here',
    'dashboard.products.orClickToUpload': 'or click to upload from your device',
    'dashboard.products.uploadedImages': 'Uploaded Images',
    'dashboard.products.selectProductFirst': 'Please select a product first',
    'dashboard.products.manageImages': 'Manage Images',
    'dashboard.products.noProductSelected': 'No product selected',
    ...
    'dashboard.products.confirmDelete': 'Confirm Delete',
    'dashboard.products.deleteImageConfirmation': 'Are you sure you want to delete this image? This action cannot be undone.',
    ...
    'dashboard.marketInsights.loading': 'Loading business insights...',
  ...
  ja: {
    ...
    'dashboard.products.uploadImages': '画像をアップロード',
    'dashboard.products.uploadImagesFor': 'の画像をアップロード',
    'dashboard.products.dragDropImages': 'ここに画像をドラッグ＆ドロップ',
    'dashboard.products.orClickToUpload': 'またはクリックしてデバイスからアップロード',
    'dashboard.products.uploadedImages': 'アップロード済み画像',
    'dashboard.products.selectProductFirst': '最初に製品を選択してください',
    'dashboard.products.manageImages': '画像を管理',
    'dashboard.products.noProductSelected': '製品が選択されていません',
    'dashboard.products.selectProduct': '画像をアップロードする製品を選択',
    'dashboard.products.upload': 'アップロード',
    'dashboard.products.aiEnhance': 'AI画像強化',
    'dashboard.products.aiEnhanceDescription': 'AIを使用して商品画像を強化する',
    ...
    'dashboard.tickets.date': '日付',
    'dashboard.tickets.actions': 'アクション',
    'dashboard.tickets.view': '表示',
    'dashboard.tickets.close': '閉じる',
    'dashboard.tickets.reopen': '再開',
    'dashboard.tickets.delete': '削除',
    'dashboard.tickets.loading': 'チケットを読み込み中...',
    'dashboard.tickets.tryAgain': '再試行',
    'dashboard.tickets.noTickets': '作成されたチケットはありません',
    'dashboard.tickets.tickets': 'チケット',
    'dashboard.tickets.descending': '降順',
    'dashboard.tickets.ascending': '昇順',
    'dashboard.tickets.sortByDate': '日付',
    'dashboard.tickets.sortByPriority': '優先度',
    'dashboard.tickets.sortByStatus': 'ステータス',
    'dashboard.tickets.responses': '返信',
    'dashboard.tickets.noResponses': '返信はまだありません',
    'dashboard.tickets.addResponse': '返信を追加',
    'dashboard.tickets.typeResponse': '返信を入力してください...',
    'dashboard.tickets.submitting': '送信中...',
    'dashboard.tickets.staff': 'スタッフ',
    'dashboard.tickets.user': 'ユーザー',
    'dashboard.tickets.aiSuggestion': 'AI提案',
    'dashboard.tickets.generating': '生成中...',
    'dashboard.tickets.statusOpen': '未解決',
    'dashboard.tickets.statusClosed': '解決済み',
    'dashboard.tickets.statusPending': '保留中',
    'dashboard.tickets.priorityLow': '低',
    'dashboard.tickets.priorityMedium': '中',
    'dashboard.tickets.priorityHigh': '高',
    'dashboard.tickets.priorityUrgent': '緊急',
    'dashboard.tickets.filterAll': 'すべて',
    'dashboard.tickets.filterByStatus': 'ステータスでフィルター',
    'dashboard.tickets.filterByPriority': '優先度でフィルター',
    'dashboard.tickets.filterByCategory': 'カテゴリーでフィルター',
    'dashboard.tickets.description': '説明',
    'dashboard.tickets.category': 'カテゴリー',
    'dashboard.tickets.submit': '送信',
    'dashboard.submit': '送信',
    ...
    'dashboard.marketInsights.loading': 'ビジネスインサイトを読み込んでいます...',
